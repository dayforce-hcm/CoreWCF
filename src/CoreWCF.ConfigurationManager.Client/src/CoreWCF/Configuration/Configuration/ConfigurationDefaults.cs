...
namespace CoreWCF.ConfigurationManager.Client
{
    ...
    {
        internal const HostNameComparisonMode HostNameComparisonMode = 0;
        ...
        internal const TransferMode TransferMode = 0;
    ...
    {
        internal const SecurityKeyType DefaultKeyType = 0;
