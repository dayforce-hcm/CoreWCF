...
namespace CoreWCF.ConfigurationManager.Client
{
    public class HttpTransportElement : TransportElement
    {
        ...
        public ExtendedProtectionPolicyElement ExtendedProtectionPolicy
        {
            get 
            { 
                var value = (ExtendedProtectionPolicyElement)base[ConfigurationStrings.ExtendedProtectionPolicy];
                if (value == null)
                {
                    value = new ExtendedProtectionPolicyElement();
                    base[ConfigurationStrings.ExtendedProtectionPolicy] = value;
                }
                return value;
            }
